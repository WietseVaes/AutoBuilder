...
# Julia solution: expected values are baked at build time; no import needed.
HEADER = _HEADER_BASE + '''
import solution
...
HEADER_NO_SOLUTION = _HEADER_BASE + '''
...
def generate_test_file(test_suite, has_python_solution=True):
    header = HEADER if has_python_solution else HEADER_NO_SOLUTION
